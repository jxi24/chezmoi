...
M.set_battery = function()
   ...
   for _, b in ipairs(wezterm.battery_info()) do
      ...
      color_idx = math.clamp(math.round(b.state_of_charge * 4), 1, 2)
   ...
   M.push(charge, icon, M.colors.battery_fg[color_idx], M.colors.battery_bg, false)
end

M.setup = function()
   wezterm.on('update-right-status', function(window, _pane)
      M.cells = {}
      M.push(window:active_workspace(), "", M.colors.workspace_fg, M.colors.workspace_bg, true)
      M.set_date()
      M.set_battery()
